  ...
  try {
    ...
    const [
      ...
      supabaseAdmin
        ...
        .select("id, submitted_at, contact_id, landing_page_id")
    ...
    const recentLeads = (recentLeadSubs.data ?? []).map((r: { id: string; contact_id: string; landing_page_id: string | null; submitted_at: string }) => {
